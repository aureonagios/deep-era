# AI Deep Era v0.31.0 — give the blind AI developer eyes

[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](LICENSE)
[![Node](https://img.shields.io/badge/Node-%3E%3D18-blue.svg)](package.json)
[![Tests](https://img.shields.io/badge/Tests-67%20passing-brightgreen.svg)](tests/run.js)
...
## Self-proof (v0.31.0, just ran)
- `npm test` → 46 unit + 13 CLI + 8 MCP = **67 green**
