# AI Deep Era v0.30.0 — give the blind AI developer eyes

[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](LICENSE)
[![Node](https://img.shields.io/badge/Node-%3E%3D18-blue.svg)](package.json)
[![Tests](https://img.shields.io/badge/Tests-65%20passing-brightgreen.svg)](tests/run.js)
...
## Self-proof (v0.30.0, just ran)
- `npm test` → 45 unit + 12 CLI + 8 MCP = **65 green**
