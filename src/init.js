...
const AGENTS_MD = `# AI Deep Era v0.46 — Agent Rules (AUTO-INSTALLED, DO NOT SKIP)
...
async function runInit(cwd) {
  ...
  fs.writeFileSync(
    path.join(cwd, ".deep-era", "RULES.md"),
    AGENTS_MD + `\nStack: ${map.stack.kind}\nFiles: ${map.counts.total}\n` + renderPack(map.stack.kind)
  );
...
module.exports = { runInit, AGENTS_MD };
